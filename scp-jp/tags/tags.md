...
* ,,︁,,: **使用禁止** _
このタグが付与されるべきページを作成すること、このタグを既存のページに付与すること、このタグを解除することは禁止されています。これらを行いたい場合、スタッフに連絡してください。
 ...
 * **[[[/system:page-tags/tag/lost-series|lost-series]]]** //(lost-series)// - enにおけるSCP記事のうち、"Lost Series"へ属するものに付与されるタグです。必ず//en//及び//scp//タグと併用されねばなりません。[[footnote]]当分類はenにおけるタグリスト追記までの暫定的措置であり、今後変更される可能性があります。[[/footnote]]
...
* ,,,,,,,,**[[[/system:page-tags/tag/資料|資料]]]** //(resource)// - 主に、財団世界観についての様々な情報を集約したページに付与されるタグです。必要に応じて追記や更新が行われる場合があります。設定集タグとは併用できません。
...
* ,,,,**[[[/system:page-tags/tag/フラグメント|フラグメント]]]** //(fragment)// - 他ページを親に持ち、そのページのための内容のみを含み、そのページにインポートされるページに付与されるタグです。この種のページは{{fragment:}}カテゴリに作成されている必要があります。また、制限緩和/翻訳(,,,,)に該当するタグが付与されていない、かつ親ページに制限タグが付与されている場合は親ページと同様の制限を引き継ぎます。Wikiに親ページが存在する限り削除対象から除外されますが、//孤立//ページとなった、あるいは親ページが削除された場合、即時削除の対象となります。他のメジャータグとの併用は、スタッフが許可を出した場合にのみ認められます。
...
* **[[[/system:page-tags/tag/メタデータ|メタデータ]]]** //(metadata)// - SCP一覧など、記事のメタデータを含むページに付与されるタグです。
...
* **[[[/system:page-tags/tag/argus|argus]]]** //(argus)// - オブジェクトクラス: Argus
 ...
 * その他の絶滅した古生物については//古生物//タグも参照してください。
 ...
 * 適切ならば//動物//タグと併用してください。
* **[[[/system:page-tags/tag/齧歯類|齧歯類]]]** //(rodent)// - 齧歯類であるか、それらに影響を及ぼすか類似しているSCPの記事に付与されるタグです。マウス・ラット・リス・ビーバーを含みます。
 * 適切ならば//動物//タグと併用してください。
 ...
 * 適切ならば//動物//タグと併用してください。
 * 適切ならば//無脊椎動物//タグの代わりに使用してください。
* **[[[/system:page-tags/tag/古生物|古生物]]]** - SCP-JP独自のアトリビュートタグです。紀元前までに絶滅した既知の古生物であるか。それらに影響を及ぼすか、古生物と極めて強い関係性を持つと思われるSCPの記事に付与されるタグです。
 * 恐竜・翼竜・絶滅した海洋爬虫類については、適切ならば//恐竜//タグを代わりに使用してください。
...
* **[[[/system:page-tags/tag/排泄|排泄]]]** - SCP-JP独自のアトリビュートタグです。排泄行為そのものであるか、それに関連もしくは影響するSCPの記事に付与されるタグです。便や尿などの排泄物、便器やトイレットペーパーなどの排泄に関連する物品を含み、SCPが排泄する物やそのプロセスが異常である場合も該当します。
...
++ 環境系[[# attribute-environment]]
SCPの所在、由来を説明するか、あるいは特定の場所や自然現象に関係するか影響するSCPの記事に付与されるアトリビュートタグです。
 ...
 * 適切ならば//家電//・//芸術//・//衣類//・//コンピュータ//・//文書//・//食物//・//装飾品//・//記憶媒体//・//道具//・//玩具//・//乗り物//・//武器//・//容器//・//家具//タグを代わりに使用してください。
 ...
 * 適切ならば//人工//タグの代わりに使用してください。
 * 適切ならば//映画//・//音楽//・//芸能//・//写真//・//彫像//タグを代わりに使用してください。
...
* **[[[/system:page-tags/tag/_hmfscp|_hmfscp]]]** //(_hmfscp)// - 超常現象の確保収容に関する王立財団 / 珍品と過ぎ往く幻想の研究の為の王立財団 (HMFSCP)のGoIフォーマット記事に付与されるタグです。
 * 必ず//hmfscp//タグと併用してください。
 ...
 * JPではENを踏襲し、パラウォッチWiki内フォーラム上のやり取りを中心とした記事に"tale"タグ、フォーラムから逸脱した形式の記事に"goi-format"タグが付与されます。
...
* **[[[/system:page-tags/tag/_トトレイソフト|_トトレイソフト]]]** //(_totleighsoft)// - [[[totleighsoft-hub|トトレイソフト]]]のGoIフォーマット記事に付与されるタグです。
 * 必ず//トトレイソフト//タグと併用してください。
 ...
 * ,,︁,,**[[[/system:page-tags/tag/合同編集|合同編集]]]** - サイト全体で共有することが求められる//合作//ページに付与されるタグです。必ず//合作//タグと併用されねばなりません。大規模なページ様式の変更の際にはスタッフの許可が必要です。
...
* ,,︁,,**[[[/system:page-tags/tag/注目の翻訳記事|注目の翻訳記事]]]** - 注目の翻訳記事選定チームによって指定された、 注目の翻訳記事に付与されるタグです。//jp//タグが付与されていないSCP、GoIフォーマット、Taleからそれぞれ選ばれます。
...
* **[[[/system:page-tags/tag/hu|hu]]]** - SCP-HU(ハンガリー語版サイト)から翻訳されたオリジナルのページに付けられるタグです。
* **[[[/system:page-tags/tag/kz|kz]]]** - SCP-KZ(カザフ語版サイト)から翻訳されたオリジナルのページに付けられるタグです。
...
[[/tab]]
[[tab ジャンル]]
創作物 (//scp//, //goi-format//, //tale//, およびシリーズの//ハブ//) にのみ付与できる、作品の内容や世界観、演出技法を表すタグです。
**現時点では、ジャンルタグは翻訳記事でのみ使用できます。特に注記が無い限り、SCP-JPオリジナルの記事にはこれらのタグを付与しないでください。**

+++ 類型系

作品の類型 (ジャンル) を表します。

* **[[[/system:page-tags/tag/不条理劇|不条理劇]]]** //(absurdism)// - 笑いや衝撃を与えることを目的に、合理的な説明や意味を欠いた事象を描いた作品。
 * //シュルレアリスム//タグも参照してください。
* **[[[/system:page-tags/tag/アクション|アクション]]]** //(action)// - 刺激的な出来事や、豪快な暴力に焦点を当てた作品。
* **[[[/system:page-tags/tag/アドベンチャー|アドベンチャー]]]** //(adventure)// - 非日常的な環境を冒険することに焦点を当てた作品。
* **[[[/system:page-tags/tag/ほろ苦|ほろ苦]]]** //(bittersweet)// - 痛みを伴う勝利や、前向きではあるが切ない別れなどを中心とした、ネガティブとポジティブの入り混じった感情を喚起させることを目的とした作品。
 * //ダーク//タグや//ハートフル//タグとの併用は避けてください。
* **[[[/system:page-tags/tag/ダーク|ダーク]]]** //(bleak)// - 苦悶、窮乏、辛苦などを中心とした、ネガティブな感情を喚起させることを目的とした作品。
 * //ハートフル//タグや//ほろ苦//タグとの併用は避けてください。
* **[[[/system:page-tags/tag/脱走劇|脱走劇]]]** //(breakout)// - 収容違反や、監禁状態からの脱出の試みに焦点を当てた作品。結果として成功するか失敗するかを問いません。
 * //追走劇//タグも参照してください。
* **[[[/system:page-tags/tag/コメディ|コメディ]]]** //(comedy)// - 面白おかしい気持ちを喚起させることを目的とした作品。
* **[[[/system:page-tags/tag/ブラックコメディ|ブラックコメディ]]]** //(black-comedy)// - ユーモアのために不愉快あるいはショッキングな出来事を描く作品。
 * 必ず//コメディ//タグと併用されねばなりません。
* **[[[/system:page-tags/tag/追走劇|追走劇]]]** //(chase)// - 逃走または追跡に焦点を当てた作品。
 * //脱走劇//タグも参照してください。
* **[[[/system:page-tags/tag/クライムフィクション|クライムフィクション]]]** //(crime-fiction)// - 犯罪者と法執行機関に焦点を当てた作品。
* **[[[/system:page-tags/tag/ファンタジー|ファンタジー]]]** //(fantasy)// - 神話や民話、伝説に影響を受けたような、魔法や超自然存在を描いた作品。
 *  扱う事柄や存在に具体的な典拠がある場合は、//神話//タグも参照してください。
* **[[[/system:page-tags/tag/ハートフル|ハートフル]]]** //(heartwarming)// - 心地良い体験や、互いを支え合うような関係性などを中心とした、ポジティブな感情を喚起させることを目的とした作品。
 * //ダーク//タグや//ほろ苦//タグとの併用は避けてください。
* **[[[/system:page-tags/tag/ホラー|ホラー]]]** //(horror)// - 読者に恐怖、ショック、嫌悪感を抱かせることを目的とした作品。
* **[[[/system:page-tags/tag/ボディホラー|ボディホラー]]]** //(body-horror)// - 肉体の破壊や変容に焦点を当てた作品。
 * 必ず//ホラー//タグと併用されねばなりません。
* **[[[/system:page-tags/tag/コズミックホラー|コズミックホラー]]]** //(cosmic-horror)// - 得体の知れない理解不能な存在を軸として、人類の矮小で無知蒙昧なさまに焦点を当てた作品。
 * 必ず//ホラー//タグと併用されねばなりません。
* **[[[/system:page-tags/tag/サイコホラー|サイコホラー]]]** //(psychological-horror)// - 心理的苦痛や精神的不安定性に焦点を当てた作品。
 * 必ず//ホラー//タグと併用されねばなりません。
* **[[[/system:page-tags/tag/メタフィクション|メタフィクション]]]** //(metafiction)// - 作中で架空の話であることに触れている、フィクションそのものについてのフィクションである作品。現実に影響を及ぼす創作物や、創作物に出入りするキャラクター、あるいは登場人物が自らを架空の存在だと認識していたり、物語上の約束に影響を受ける描写などに焦点を当てる傾向にあります。
 * //メタ// (アトリビュートタグ) とは異なります。
 * SCP記事では、適切ならば//語り// (アトリビュートタグ) が併用されます。
* **[[[/system:page-tags/tag/ミリタリーフィクション|ミリタリーフィクション]]]** //(military-fiction)// - 兵士やフィールドエージェント、傭兵に焦点を当てた作品。
 * SCP記事では、適切ならば//軍事// (アトリビュートタグ) が併用されます。
* **[[[/system:page-tags/tag/ミステリー|ミステリー]]]** //(mystery)// - 未解決な問題の探求に焦点を当てた作品。
* **[[[/system:page-tags/tag/宗教フィクション|宗教フィクション]]]** //(religious-fiction)// - 宗教、信仰、信念に焦点を当てた作品。実在の宗教だけでなく、異常実体に対する信仰の描写も対象になります。
 * //神話//タグも参照してください。
 * SCP記事では、適切ならば//宗教// (アトリビュートタグ) が併用されます。
* **[[[/system:page-tags/tag/ロマンス|ロマンス]]]** //(romance)// - 登場人物間の恋愛関係に焦点を当てた作品。
* **[[[/system:page-tags/tag/サイエンスフィクション|サイエンスフィクション]]]** //(science-fiction)// - 高度な科学技術を描いた作品。現状では不可能だと考えられている事物を科学的に分析するものも含みます。
* **[[[/system:page-tags/tag/日常系|日常系]]]** //(slice-of-life)// - ありふれた出来事に焦点を当てた、登場人物たちの日常生活を垣間見ることができる作品。
* **[[[/system:page-tags/tag/スパイフィクション|スパイフィクション]]]** //(spy-fiction)// - 諜報、防諜、二重スパイや暗殺に焦点を当てた作品。
* **[[[/system:page-tags/tag/シュルレアリスム|シュルレアリスム]]]** //(surrealism)// - 不可能・不合理な物事と普通の物事を、潜在意識に眠る互いの関連性を軸に対置してみせることによって、夢の中のような物語を構築している作品。単に奇妙なものを指す場合の"シュール"とは異なります。
 * //不条理劇//タグも参照してください。
* **[[[/system:page-tags/tag/異種フィクション|異種フィクション]]]** //(xenofiction)// - エイリアンや動物、モンスターや機械といった、人間以外の視点から描かれた作品。ただし"元人間のウミウシ"のような、精神的には普通の人間と変わらない存在が視点主の場合は該当しません。

+++ 題材系

作品の主要な題材 (テーマ) を表します。

* **[[[/system:page-tags/tag/エイリアン|エイリアン]]]** //(alien)// - 地球外の生物、特に異なる惑星から来た知的生命体が登場する作品。
 * 適切ならば//サイエンスフィクション//タグと併用してください。
 * SCP記事では、適切ならば//地球外// (アトリビュートタグ) が併用されます。
* **[[[/system:page-tags/tag/人工知能|人工知能]]]** //(artificial-intelligence)// - 人工知能、ないしは人工知能を搭載したアノマリーや、人工知能に影響を及ぼすアノマリーが登場する作品。
 * 適切ならば//サイエンスフィクション//タグと併用してください。
 * SCP記事では、適切ならば//コンピュータ//または//自動装置// (アトリビュートタグ) が併用されます。
* **[[[/system:page-tags/tag/官僚主義|官僚主義]]]** //(bureaucracy)// - 組織の運営、管理、事務手続に焦点を当てた作品。
* **[[[/system:page-tags/tag/悪魔|悪魔]]]** //(demon)// - 悪徳、誘惑、地獄といった要素と関連付けられる超自然的存在が登場する作品。
 * 適切ならば//ファンタジー//タグと併用してください。
* **[[[/system:page-tags/tag/妖精|妖精]]]** //(faerie)// - ヨーロッパの民間伝承における"妖精"のような超自然的存在が登場する作品。
 * 適切ならば//ファンタジー//タグと併用してください。
* **[[[/system:page-tags/tag/幽霊|幽霊]]]** //(ghost)// - 幽霊や亡霊、より堅く言えば霊的実体と呼ばれる存在が登場する作品。
 * __SCP-JPオリジナル記事での使用に関しては、アトリビュートタグ「霊体」を参照してください。__
* **[[[/system:page-tags/tag/歴史|歴史]]]** //(historical)// - 歴史上の出来事、ないしは歴史的意義を持つアノマリーに焦点を当てた作品。
 * //時代物//タグも参照してください。
 * __SCP-JPオリジナル記事での使用に関しては、アトリビュートタグ「歴史」を参照してください。__
* **[[[/system:page-tags/tag/ジャーナリズム|ジャーナリズム]]]** //(journalism)// - ジャーナリスト、評論家、報道やニュース記事に焦点を当てた作品。
* **[[[/system:page-tags/tag/法律|法律]]]** //(legal)// - 法律や法的手続、法的文書に焦点を当てた作品。
 * __SCP-JPオリジナル記事での使用に関しては、アトリビュートタグ「法律」を参照してください。__
* **[[[/system:page-tags/tag/lgbtq|lgbtq]]]** //(lgbtq)// - LGBTQ+の題材、文化、歴史に焦点を当てた作品。ゲイやレズビアンの関係の描写、アセクシャルやバイセクシャルの表現、トランス、クィア、Aジェンダー等のアイデンティティの掘り下げが該当例として挙げられます。
* **[[[/system:page-tags/tag/殺人モンスター|殺人モンスター]]]** //(murder-monster)// - 敵対的で人命に危害を加えようとする、人間以外のアノマリーが登場する作品。
 * 適切ならば//ホラー//タグと併用してください。
* **[[[/system:page-tags/tag/神話|神話]]]** //(mythological)// - 特定の神話伝承や民話風の形式で書かれているか、それらを典拠としている生き物・出来事・儀礼的行為が登場する作品。既に宗教的行為として確立されているものに関しては対象に含みません。
 * //ファンタジー//タグや//宗教フィクション//タグも参照してください。
 * //神話伝説// (アトリビュートタグ-CN) とは異なります。
...
作品の舞台になっている場所や時期、世界観を表します。

* **[[[/system:page-tags/tag/死後|死後]]]** //(afterlife)// - 死後の意識の行く末について描いているか、死後の世界に関連する作品。
 * __SCP-JPオリジナル記事での使用に関しては、アトリビュートタグ「死後」を参照してください。__
* **[[[/system:page-tags/tag/架空史|架空史]]]** //(alternate-history)// - 歴史改変SFや架空戦記などとも呼ばれる、史実から乖離した歴史的出来事を扱った作品。記事内での"一般に知られている歴史"が現実のそれとは大きく異なっている場合にのみ適用され、[[[ad-astra-per-aspera-hub|未来の出来事]]]や、史実の出来事の超常版再解釈 (第七次オカルト戦争など) には適用されません[[footnote]]財団やアノマリーの存在は史実にない要素ではありますが、それらが隠蔽されているため表面上は歴史に大きな差異は無いと判断されます。すなわち「[[[broken-masquerade-hub|壊された虚構]]]」は財団の存在が明らかになり世界が劇的に変化するため付与対象となりますが、「[[[unfounded-hub|財団のない世界]]]」は財団がない以外概ね同じように歴史が進むという前提が共有されているため、通常は付与対象となりません。[[/footnote]]。
* **[[[/system:page-tags/tag/アポカリプス|アポカリプス]]]** //(apocalyptic)// - 滅亡の最中や直前を舞台にした作品。
 * //ポストアポカリプス//タグも参照してください。
 * SCP記事では、適切ならば//k-クラスシナリオ// (アトリビュートタグ) が併用されます。
* **[[[/system:page-tags/tag/ポストアポカリプス|ポストアポカリプス]]]** //(post-apocalyptic)// - 滅亡後の世界を舞台にした作品。
 * //アポカリプス//タグも参照してください。
 * SCP記事では、適切ならば//k-クラスシナリオ// (アトリビュートタグ) が併用されます。
* **[[[/system:page-tags/tag/クリスマス|クリスマス]]]** //(christmas)// - クリスマス・ホリデーを舞台にしているか、クリスマスに関する事柄を踏まえた作品。
* **[[[/system:page-tags/tag/企業|企業]]]** //(corporate)// - 会社や事業者の活動に焦点を当てた作品。
 * __SCP-JPオリジナル記事での使用に関しては、アトリビュートタグ「企業」を参照してください。__
* **[[[/system:page-tags/tag/ディストピア|ディストピア]]]** //(dystopian)// - 現実のそれよりも遥かに劣悪なものとして描かれる、実在しない社会や文明を扱った作品。
* **[[[/system:page-tags/tag/ハロウィン|ハロウィン]]]** //(halloween)// - ハロウィン・ホリデーを舞台にしているか、ハロウィンに関する事柄を踏まえた作品。
* **[[[/system:page-tags/tag/別世界|別世界]]]** //(otherworldly)// - 別の世界や現実、ユニバースを舞台とした作品。具体的には、作中を通して地球ではないどこかを舞台とした作品や、ポータルなどを介して異なる世界に迷い込むファンタジー作品を含みます。
 * 適切ならば//ファンタジー//タグや//サイエンスフィクション//タグと併用してください。
 * SCP記事では、適切ならば//異次元//または//地球外// (アトリビュートタグ) が併用されます。
* **[[[/system:page-tags/tag/時代物|時代物]]]** //(period-piece)// - 過去の特定の時代を舞台とした作品。
 * //歴史//タグも参照してください。
* **[[[/system:page-tags/tag/学校|学校]]]** //(school)// - 学校や大学、その他様々な教育機関に焦点を当てた作品。
* **[[[/system:page-tags/tag/スペースオペラ|スペースオペラ]]]** //(space-opera)// - 宇宙や他星に存在する未来の文明を舞台として、ドラマチックな出来事や冒険を中心的に描いた作品。
 * 適切ならば//サイエンスフィクション//タグや//エイリアン//タグ、//別世界//タグと併用してください。
* **[[[/system:page-tags/tag/ユートピア|ユートピア]]]** //(utopian)// - 現実のそれよりも遥かに優秀なものとして描かれる、実在しない社会や文明を扱った作品。
* **[[[/system:page-tags/tag/西部劇|西部劇]]]** //(western)// - 西部開拓時代のアメリカン・フロンティアを舞台とした作品。
 * //時代物//タグも参照してください。

+++ 形式系

作品の形式 (スタイル) を表します。この分類のタグは**//tale//にのみ付与可能**であり、//scp//や//goi-format//、シリーズの//ハブ//には使用できません。

* **[[[/system:page-tags/tag/書簡体|書簡体]]]** //(correspondence)// - 書簡体小説と呼ばれる、登場人物間による文面上での対話が主体となっている作品です。手紙、Eメール、テキストメッセージやSNSの投稿などでのやりとりが含まれます。
 * 必ず//tale//タグと併用されねばなりません。
* **[[[/system:page-tags/tag/クリーピーパスタ|クリーピーパスタ]]]** //(creepypasta)// - 古典的インターネットホラー風の短編作品。通常、財団が登場することはありません。
 * 必ず//tale//タグと併用されねばなりません。
 * __SCP-JPオリジナル記事での使用に関しては、メジャータグ「クリーピーパスタ」を参照してください。__
* **[[[/system:page-tags/tag/一人称|一人称]]]** //(first-person)// - 一人称視点で描写した (「私は～した」等) 作品。
 * 必ず//tale//タグと併用されねばなりません。
...
* **[[[/system:page-tags/tag/_ジャンルレス|_ジャンルレス]]]** //(_genreless)// - 類型、主題、舞台、形式のタグが付与されていない作品。
[[/tab]]
[[tab ウィキ運営用]]
...
* **[[[/system:page-tags/tag/ブラックダイヤモンド・ビリオンズ|ブラックダイヤモンド・ビリオンズ]]]** //(black-diamond-billions)// - [[[black-diamond-billions-hub|ブラックダイヤモンド・ビリオンズ]]]。
...
* **[[[/system:page-tags/tag/忘れられた記憶|忘れられた記憶]]]** //(forgotten-memories)// - [[[forgotten-memories-hub|忘れられた記憶]]]。
...
* **[[[/system:page-tags/tag/第九世界|第九世界]]]** //(ninth-world)// - [[[the-ninth-world-hub|第九世界]]]。
...
* **[[[/system:page-tags/tag/記号論|記号論]]]** //(semiotics)// - [[[semiotics-hub|記号論]]]。
* **[[[/system:page-tags/tag/シリーズ0|シリーズ0]]]** //(series-0)// - [[[series-0|シリーズ0]]]。
...
* **[[[/system:page-tags/tag/サメきった世界|サメきった世界]]]** //(the-sharkest-timeline)// - [[[the-sharkest-timeline|サメきった世界]]]。
...
* **[[[/system:page-tags/tag/世界は廻り続けた|世界は廻り続けた]]]** //(world-kept-turning)// - [[[the-world-kept-turning-hub|世界は廻り続けた]]]。
...
* **[[[/system:page-tags/tag/静かなる流れ|静かなる流れ]]]** //(тихое_течение)// - [[[quiet-current-hub|通時無謬性保証部門]]]。
 ...
 * **[[[/system:page-tags/tag/太陽が沈む時-scp|太陽が沈む時-scp]]]** //(soleil-couche-scp)// - "太陽が沈む時"のデリバティブ記事[[footnote]]SCP-FR独自の記事区分です。[#faq 翻訳に関するFAQ]の項目も参照してください。 [[/footnote]]。
...
+++ カノン-CS
それぞれの概要は[[[canon-hub-cs|]]]を参照してください。

* **[[[/system:page-tags/tag/チェコscp財団|チェコscp財団]]]** //(česká-větev)// - [[[informace-o-ceske-vetvi-nadace|チェコSCP財団]]]。
* **[[[/system:page-tags/tag/不河思議|不河思議]]]** //(řekytaj)// - [[[rekytaj-hub|不河思議]]]。
* **[[[/system:page-tags/tag/金の鳥籠|金の鳥籠]]]** //(zlatá-klec)// - [[[zlata-klec-hub|金の鳥籠]]]。
* **[[[/system:page-tags/tag/ジシュコフの穴蔵|ジシュコフの穴蔵]]]** //(žižkovská-díra)// - [[[zizkovska-dira-hub|ジシュコフの穴蔵]]]。
...
[[tab VN]]
+++ カノン-VN
それぞれの概要は[[[canon-hub-vn|]]]を参照してください。

* **[[[/system:page-tags/tag/心霊課|心霊課]]]** //(đơn-vị-tâm-linh)// - [[[don-vi-tam-linh-hub|心霊課]]]。
[!--* **[[[/system:page-tags/tag/|]]]** //(flower-heaven)// - [[[flower-heaven-hub|]]]。--]
[!--* **[[[/system:page-tags/tag/|]]]** //(phụ-huynh-giám-sát)// - [[[parental-guidance-hub|]]]。--]
* **[[[/system:page-tags/tag/密林より興る|密林より興る]]]** //(từ-rừng-đi-lên)// - [[[tu-rung-di-len-hub|密林より興る]]]。
...
* **[[[/system:page-tags/tag/8000匹の死んだネズミ|8000匹の死んだネズミ]]]** //(8000-dead-rats)// - [[[8000-dead-rats-hub|8000匹の死んだネズミ]]]。
...
* **[[[/system:page-tags/tag/キレイさっぱりをお約束します|キレイさっぱりをお約束します]]]** //(cleanliness-guaranteed)// - [[[cleanliness-guaranteed-hub|キレイさっぱりをお約束します*]]]。
* **[[[/system:page-tags/tag/創造性の破壊|創造性の破壊]]]** //(creative-destruction)// - [[[creative-destruction-hub|創造性の破壊]]]。
* **[[[/system:page-tags/tag/コレクターtale|コレクターtale]]]** //(collector-tale)// - ミスター・コレクター(参照: //[[[/system:page-tags/tag/mister|mister]]]//タグ)。
* **[[[/system:page-tags/tag/四季の円環|四季の円環]]]** //(cycle-of-seasons)// - [[[cycle-of-seasons-hub|四季の円環]]]。
* **[[[/system:page-tags/tag/etdp|etdp]]]** //(etdp)// - [[[etdp-hub-page|そして私は神を求めた]]]。
* **[[[/system:page-tags/tag/エバー・アフター|エバー・アフター]]]** //(ever-after)// - [[[ever-after-hub|エバー・アフター]]]。
...
* **[[[/system:page-tags/tag/ノー・ウェイヴ|ノー・ウェイヴ]]]** //(no-wave)// - [[[no-wave|ノー・ウェイヴ]]]。
...
* **[[[/system:page-tags/tag/実録犯罪|実録犯罪]]]** //(parawatch-true-crime)// - [[[crewtime|月例ディスカッション: 実録犯罪]]]。
* **[[[/system:page-tags/tag/恐怖症アンソロジー|恐怖症アンソロジー]]]** //(phobia-anthology)// - [[[scp-anthology-2024|恐怖症ホラーアンソロジー]]]。
...
* **[[[/system:page-tags/tag/十三の茨|十三の茨]]]** //(thirteen-thorns)// - [[[thirteen-thorns-hub|十三の茨]]]。
...
* **[[[/system:page-tags/tag/また会う度に|また会う度に]]]** //(we-meet-again)// - [[[and-every-time-we-meet-again-hub|そして、また会う度に]]]。
* **[[[/system:page-tags/tag/血の娼婦|血の娼婦]]]** //(whore-of-blood)// - [[[whore-of-blood-hub|血の娼婦]]]。
* **[[[/system:page-tags/tag/w-i-t-c-h|w-i-t-c-h]]]** //(w-i-t-c-h)// - Weaving Imperceptible Threads Continuity。
...
* **[[[/system:page-tags/tag/paradise|paradise]]]** //(paradise)// - Paradise。
...
* **[[[/system:page-tags/tag/海の底からの物語|海の底からの物語]]]** //(morskie-opowieści)// - [[[morskie-opowiesci|海の底からの物語]]]。
...
* **[[[/system:page-tags/tag/理想と報復|理想と報復]]]** //(lý-tưởng-và-trả-thù)// - [[[ideal-and-revenge-hub|理想と報復]]]。
[!--* **[[[/system:page-tags/tag/|]]]** //(bảy-đại-tội)// - [[[seven-sins-hub|]]]。--]
* **[[[/system:page-tags/tag/審判者の随筆|審判者の随筆]]]** //(phán-sự-tùy-bút)// - 審判者の随筆。
[!--* **[[[/system:page-tags/tag/|]]]** //(tết-tưng-bừng)// - [[[tet-holiday-hub|]]]。--]
...
* **[[[/system:page-tags/tag/ゴールドベイカー・ラインツ|ゴールドベイカー・ラインツ]]]** //(goldbaker-reinz)// - [[[goldbaker-reinz-hub|ゴールドベイカー・ラインツ]]]。
...
* **[[[/system:page-tags/tag/シン・ノンブレ・カルテル|シン・ノンブレ・カルテル]]]** //(sin-nombre-cartel)// - シン・ノンブレ麻薬カルテル。
...
* **[[[/system:page-tags/tag/日本生類創研|日本生類創研]]]** //(joicl)// - 要注意団体-JPの項を参照してください。
...
* **[[[/system:page-tags/tag/フィンフォーク|フィンフォーク]]]** //(finnfolk)// - [[[seas-of-orcadia-hub|オルカディア]]]の有鰭人/Homo aquarius。
...
* **[[[/system:page-tags/tag/malo|malo]]]** //(malo)// - [[[SCP-1471|SCP-1471-A]]]実例群、通称MalO。
...
* **[[[/system:page-tags/tag/日本生類創研|日本生類創研]]]** - [[[joicl-hub|日本生類創研]]]。
...
* **[[[/system:page-tags/tag/吟遊詩客|吟遊詩客]]]** //(吟游诗客)// - [[[waldichter-hub|吟遊詩客]]]。
* **[[[/system:page-tags/tag/彼岸|彼岸]]]** //(彼岸)// - 彼岸。
...
* **[[[/system:page-tags/tag/キャルデラ|キャルデラ]]]** //(caldeira)// - キャルデラ。
...
* **[[[/system:page-tags/tag/ハンター・インダストリーズ|ハンター・インダストリーズ]]]** //(hunter-industries)// - [[[hunter-industries-hub|ハンター・インダストリーズ]]]。
...
* **[[[/system:page-tags/tag/s&sモータライズド|s&sモータライズド]]]** //(szwagier&szwagier-motorized)// - [[[s-sm-hub|シュファギェル&シュファギェル・モータライズド]]]。
...
* **[[[/system:page-tags/tag/政治結社ルフ・アングリフ|政治結社ルフ・アングリフ]]]** //(п.о.р.а.)// - 政治結社ルフ・"アングリフ" (P.O.R.A.)。
...
* **[[[/system:page-tags/tag/国安十九局|国安十九局]]]** //(國安十九局)// - 中華人民共和国国家安全部異常十九局。
...
* **[[[/system:page-tags/tag/地質学部門|地質学部門]]]** //(geology-dept)// - 地質学部門。
* **[[[/system:page-tags/tag/数学部門|数学部門]]]** //(mathematics-dept)// - [[[math-department-hub|数学部門]]]。
...
* **[[[/system:page-tags/tag/スパイシー・クラスト・ピッツェリア|スパイシー・クラスト・ピッツェリア]]]** //(spicy-crust-pizzeria)// - 財団のフロント企業、スパイシー・クラスト・ピッツェリアまたはスパイシー・クラスト・ピザ。
...
* **[[[/system:page-tags/tag/dira|dira]]]** //(dira)// - [[[dira-hub|内部調査分析部門 (DIRA)]]]。
DIRAハブはカノンハブに掲載されているが、タグの方は部門タグとしてリストに掲載されている。どっちだ
[[/tab]]RU--]
[[tab KO]]
...
[!--
* **[[[/system:page-tags/tag/都異部門|都異部門]]]** //(都異部門)// - [[[urban-legend-department|]]]基金會都市傳說型異常應對部門，簡稱為都異部門。
* **[[[/system:page-tags/tag/SRR部|SRR部]]]** //(SRR部)// - [[[systematic-restoration-and-recollection-department|]]]系統還原與追溯部門(簡稱SRR)為RAISA-ZH的子部門之一。
...
* **[[[/system:page-tags/tag/キャプテン・エイドリアン|キャプテン・エイドリアン]]]** //(captain-adrian)// - エイドリアン、通称[[[SCP-6159|SCP-6159-2]]]。使い魔、船長、超常法務官、精神的補助動物。
...
* **[[[/system:page-tags/tag/メタノイア管理官|メタノイア管理官]]]** //(director-metanoia)// - 異常存在交流課(AEED)のアメリ・R・メタノイア管理官。
...
* **[[[/system:page-tags/tag/ギャリソン博士|ギャリソン博士]]]** //(doctor-garrison)// - ヘザー・ギャリソン博士、サイト-43のミーム学及び異常存在論のスペシャリスト。
* **[[[/system:page-tags/tag/ガット博士|ガット博士]]]** //(doctor-gat)// - アーヴィング・ガット博士、超現実部門の研究主任。
...
* **[[[/system:page-tags/tag/doctor-heiden|doctor-heiden]]]** //(doctor-heiden)// - フレドリック・ハイデン/ヘイデン博士。
...
* **[[[/system:page-tags/tag/フローレンス・ソーン|フローレンス・ソーン]]]** //(florence-thorne)// - かつてフローレンス・エルシンガーの名で財団に雇用されていたUIU所属の[[span class="ruby"]]戦闘魔道士[[span class="rt"]]バトル・メイジ[[/span]][[/span]]、[[[florence-thorne-hub|フローレンス・ソーン]]]。
...
* **[[[/system:page-tags/tag/ウェトル博士|ウェトル博士]]]** //(doctor-wettle)// - サイト-43の運の悪い再現研究部門長にして、[[[SCP-7000]]]の焦点。ウィリアム・ウォレス・ウェトル博士。
...
* **[[[/system:page-tags/tag/ラフィ・マクラファーソン|ラフィ・マクラファーソン]]]** //(laughy-mclaugherson)// - ラフィ・マクラファーソン、通称[[[SCP-2030|SCP-2030-1]]]。
...
* **[[[/system:page-tags/tag/クミホ|クミホ]]]** //(the-kumiho)// - [[span class="ruby"]]九尾狐[[span class="rt"]]クミホ[[/span]][[/span]]、通称[[[SCP-953]]]。
...
* **[[[/system:page-tags/tag/マーウ|マーウ]]]** //(marw)// - キャラクター-ESの項を参照してください。
...
* **[[[/system:page-tags/tag/エイモス・マーシャル|エイモス・マーシャル]]]** //(amos-marshall)// - マーシャル・カーター&ダーク株式会社のエイモス・マーシャル。
...
* **[[[/system:page-tags/tag/プラハのゴーレム|プラハのゴーレム]]]** //(golem-of-prague)// - ヨーゼフ・ベン・イェフダ、別名"プラハのゴーレム"。
...
* **[[[/system:page-tags/tag/ルーカス・モナコ|ルーカス・モナコ]]]** //(lucas-monaco)// - マーシャル・カーター＆ダークの従業員、ルーカス・モナコ。
...
* **[[[/system:page-tags/tag/percival-darke|percival-darke]]]** //(percival-darke)// - パーシバル・ダーケ/ダアク、マーシャル・カーター&ダーク株式会社の創設者にして、通称ロンドンの不死商人。
...
* **[[[/system:page-tags/tag/ロバート・カーター|ロバート・カーター]]]** //(robert-carter)// - マーシャル・カーター&ダーク株式会社のロバート・カーター。
* **[[[/system:page-tags/tag/ruprecht-carter|ruprecht-carter]]]** //(ruprecht-carter)// - マーシャル・カーター&ダーク株式会社のラプリクト/ルプレヒト・カーター。
...
* **[[[/system:page-tags/tag/anafabula|anafabula]]]** //(anafabula)// - 顕現した物語を完全に抹消する敵対的[[span class="ruby"]]反物語[[span class="rt"]]アナファブラ[[/span]][[/span]]、通称[[[SCP-2747]]]。
* **[[[/system:page-tags/tag/brothers-of-death|brothers-of-death]]]** //(brothers-of-death)// - brothers-of-death、[[[SCP-1440]]]で初めて言及された死の三兄弟。
...
* **[[[/system:page-tags/tag/the-serpent|the-serpent]]]** //(the-serpent)// - 放浪者の図書館の主であり、蛇の手という組織名の由来となった神話的存在、The Serpent。
* **[[[/system:page-tags/tag/ヤルダバオート|ヤルダバオート]]]** //(yaldabaoth)// - サーキック信者から[[span class="ruby"]]Važjuma[[span class="rt"]]ヴァジュマ[[/span]][[/span]]とも呼ばれる、忌み嫌われる宇宙の創造者、デミウルゴスたるヤルダバオート。
...
* **[[[/system:page-tags/tag/室中隊員|室中隊員]]]** - 室中隊員。
...
それぞれの詳細は[[[personnel-and-character-dossier-ko|職員・人物ファイル-KO]]]を参照してください。
...
* **[[[/system:page-tags/tag/ソスナ博士|ソスナ博士]]]** //(doktor-sosna)// - ヨアンナ・ソスナ博士。

+++ SCPオブジェクト-PL

* **[[[/system:page-tags/tag/話し上手|話し上手]]]** //(gawędziarz)// - 話し上手、通称[[[SCP-PL-027]]]。

+++ 要注意人物-PL

* **[[[/system:page-tags/tag/jarosław-zimorodek|jarosław-zimorodek]]]** //(jarosław-zimorodek)// - 元財団研究員であり、現潜伏治療代表のヤロスラフ/ヤロスワフ・ジモロデク。
* **[[[/system:page-tags/tag/julian|julian]]]** //(julian)// - Julian S、通称[[[SCP-PL-010|PoI-PL-010]]]。
...
* **[[[/system:page-tags/tag/トンマーゾ・パッスィーニ|トンマーゾ・パッスィーニ]]]** //(tommaso-passini)// - サイト-ケレスの管理者、トンマーゾ・パッスィーニ。
* **[[[/system:page-tags/tag/mauro-bellini|mauro-bellini]]]** //(mauro-bellini)// - サイト-プルトーネの副管理官、マウロ・ベッリーニ/ベリーニ博士。
...
* **[[[/system:page-tags/tag/ヤキム博士|ヤキム博士]]]** //(др_яким)// - ヤキム博士。
...
* **[[[/system:page-tags/tag/l・ワット研究員|l・ワット研究員]]]** //(研究員l.what)// - L.ワット研究員。
...
* **[[[/system:page-tags/tag/ヴー・クイン・トゥー管理官|ヴー・クイン・トゥー管理官]]]** //(giám-đốc-vũ-quỳnh-thư)// - サイト-29-VNのヴー・クイン・トゥー(イリーナ・ヴー)管理官。
* **[[[/system:page-tags/tag/ブイ・アイン・ドゥック|ブイ・アイン・ドゥック]]]** //(bùi-anh-đức)// - 以前はサイト-07-VNに勤務していたサイト-29-VN所属の研究員、ブイ・アイン・ドゥック。
...
* **[[[/system:page-tags/tag/吹き抜けた階段|吹き抜けた階段]]]** //(noosphere)// - [[[SCP-087]]]、吹き抜けた階段。
* **[[[/system:page-tags/tag/スリー・ポートランド|スリー・ポートランド]]]** //(three-portlands)// - [[[three-portlands-hub|スリー・ポートランド]]]。
* **[[[/system:page-tags/tag/アンダーベガス|アンダーベガス]]]** //(undervegas)// - 悪魔の街、[[[undervegas-hub|アンダーベガス]]]。
* **[[[/system:page-tags/tag/放浪者の図書館|放浪者の図書館]]]** //(wanderers-library)// - [[[wanderers-library-hub|放浪者の図書館]]]。

以下のタグについては、特定の他支部の項を参照してください。

* **[[[/system:page-tags/tag/香城|香城]]]** //(hong-shing)// - ロケーション-CNの項を参照してください。
* **[[[/system:page-tags/tag/ペケーニャ・ハバナ|ペケーニャ・ハバナ]]]** //(little-havana)// - ロケーション-ESの項を参照してください。
* **[[[/system:page-tags/tag/穴蔵|穴蔵]]]** - JP側で独自に登録されたタグです。ロケーション-JPの項を参照してください。
...
+++ JPで独自に登録されたロケーション
以下は他支部で作成されたロケーションを、JP側で独自にタグ登録したものです。運用ルールの差異から区別して掲載しています。詳細はタグガイドの[[[tag-guide#toc16|こちらの項目]]]を参照してください。
...
* **[[[/system:page-tags/tag/シウ市|シウ市]]]** //(矽宇市)// - [[span class="ruby"]][[[the-xiyu-city-hub|矽宇市]]][[span class="rt"]]シウし[[/span]][[/span]]。
...
* **[[[/system:page-tags/tag/サイト-cn-65|サイト-cn-65]]]** //(site-cn-65)// - [[[site-cn-65|サイト-CN-65]]]。
...
[!--
★未申請。
* **[[[/system:page-tags/tag/サイト-cn-64|サイト-cn-64]]]** //(site-cn-64)// - [[[site-cn-64|サイト-CN-64]]]。
...
* **[[[/system:page-tags/tag/サイト-mayim|サイト-mayim]]]** //(mayim)// - サイト-Mayim。
* **[[[/system:page-tags/tag/サイト-lamedh|サイト-lamedh]]]** //(lamedh)// - サイト-Lamedh。
...
[!--* **[[[/system:page-tags/tag/サイト-samech|サイト-samech]]]** //(samech)// - サイト-Samech。--]
...
* **[[[/system:page-tags/tag/ペケーニャ・ハバナ|ペケーニャ・ハバナ]]]** //(pequeña-habana)// - ペケーニャ・ハバナ。
...
* **[[[/system:page-tags/tag/9000|9000]]]** //(9000)// - [[[scp9000contesthub|SCP-9000コンテスト]]]。
...
+++ コンテスト-RU
* **[[[/system:page-tags/tag/掌編コンテスト2023|掌編コンテスト2023]]]** //(мс_малый_объект2023 / мс_малый_рассказ2023)// - [[[small-form-contest-iii-last-wish| 第22回コンテスト: 掌編コンIII「最後の願い」]]]。
...
* **[[[/system:page-tags/tag/2021-即興コンテスト|2021-即興コンテスト]]]** //(2021-즉흥경연-ko)// - [[[3day-writting-hub|2021即興コンテスト]]]。
...
[!--
★未申請。
* **[[[/system:page-tags/tag/2016-財団放送コンテスト|2016-財団放送コンテスト]]]** //(2016-재단방송경연)// - [[[foundation-broadcast|2016財団放送コンテスト]]]。
* **[[[/system:page-tags/tag/2017-再建コンテスト|2017-再建コンテスト]]]** //(2017-재건경연)// - [[[reconstruction-contest-hub|2017再建コンテスト]]]。
* **[[[/system:page-tags/tag/2019-師弟コンテスト|2019-師弟コンテスト]]]** //(2019-멘토&멘티)// - [[[mentor-mentee-contest|2019師弟コンテスト]]]。
* **[[[/system:page-tags/tag/2019-要注意団体コンテスト|2019-要注意団体コンテスト]]]** //(2019-요주의단체ko)// - [[[goi-ko-contest-2019|2019要注意団体-KOコンテスト]]]。
* **[[[/system:page-tags/tag/2019-クリスマスコンテスト|2019-クリスマスコンテスト]]]** //(2019-성탄경연)// - [[[contest-ko-christmas-2019|2019クリスマスコンテスト]]]。
★未申請。タグリスト-KO未掲載。
* **[[[/system:page-tags/tag/2013-ノレマイン-誕生日祝典|2013-ノレマイン-誕生日祝典]]]** //(2013-노래마인-생일축전)// - [[[birthday-shfoakdls|誕生日祝典 - ノレマイン]]]。
* **[[[/system:page-tags/tag/2020-外部文書コンテスト|2020-外部文書コンテスト]]]** //(2020-외부문서경연)// - [[[external-documents-contest-2020|2020外部文書コンテスト]]]。
...
* **[[[/system:page-tags/tag/2021-二人三脚|2021-二人三脚]]]** //(2021-2인3각)// - [[[2g3a-contest-hub|2021年二人三脚コンテスト]]]。

* **[[[/system:page-tags/tag/2022-メタタイトルコンテスト|2022-メタタイトルコンテスト]]]** //(2022-별칭경연)// - [[[title-contest-hub-2022|第二回メタタイトルコンテスト]]]。

* **[[[/system:page-tags/tag/2023-年末コンテスト|2023-年末コンテスト]]]** //(2023-연말경연-ko)// - [[[11thanniversarycontest|11周年の年末コンテスト「クリーチャー」]]]。

* [[[samcheonri-contest|三千里コンテスト]]]用のタグ
 * **[[[/system:page-tags/tag/三千里-済州コンテスト|三千里-済州コンテスト]]]** //(삼천리-제주)// - [[[samcheonri-contest-jeju|第一回「済州道」]]]。
 * **[[[/system:page-tags/tag/三千里-釜山コンテスト|三千里-釜山コンテスト]]]** //(삼천리-부산)// - [[[samcheonri-contest-busan|第二回「釜山広域市」]]]。
 * **[[[/system:page-tags/tag/三千里-蔚山コンテスト|三千里-蔚山コンテスト]]]** //(삼천리-울산)// - [[[samcheonri-contest-ulsan|第三回「蔚山広域市」]]]。
 * **[[[/system:page-tags/tag/三千里-慶南コンテスト|三千里-慶南コンテスト]]]** //(삼천리-경남)// - [[[samcheonri-contest-gyeongnam|第四回「慶尚南道」]]]。
 * **[[[/system:page-tags/tag/三千里-全南コンテスト|三千里-全南コンテスト]]]** //(삼천리-전남)// - [[[samcheonri-contest-jeonnam|第五回「全羅南道」]]]。
 * **[[[/system:page-tags/tag/三千里-光州コンテスト|三千里-光州コンテスト]]]** //(삼천리-광주)// - [[[samcheonri-contest-gwangju|第六回「光州広域市」]]]。
 * **[[[/system:page-tags/tag/三千里-全北コンテスト|三千里-全北コンテスト]]]** //(삼천리-전북)// - [[[samcheonri-contest-jeonbuk|第七回「全羅北道」]]]。
 * **[[[/system:page-tags/tag/三千里-海西コンテスト|三千里-海西コンテスト]]]** //(삼천리-해서)// - [[[samcheonri-contest-haeseo|第八回「黄海道・未収復京畿道」]]]。
 * **[[[/system:page-tags/tag/三千里-慶北コンテスト|三千里-慶北コンテスト]]]** //(삼천리-경북)// - [[[samcheonri-contest-gyeongbuk|第九回「慶尚北道 」]]]。
 * **[[[/system:page-tags/tag/三千里-大邱コンテスト|三千里-大邱コンテスト]]]** //(삼천리-대구)// - [[[samcheonri-contest-daegu|第十回「大邱広域市 」]]]。
 * **[[[/system:page-tags/tag/三千里-咸北コンテスト|三千里-咸北コンテスト]]]** //(삼천리-관북)// - [[[samcheonri-contest-gwanbuk|第十二回「咸鏡南道・咸鏡北道」]]]。
 * **[[[/system:page-tags/tag/三千里-忠北コンテスト|三千里-忠北コンテスト]]]** //(삼천리-충북)// - [[[samcheonri-contest-chungbuk|第十三回「忠清北道 」]]]。
 * **[[[/system:page-tags/tag/三千里-京畿コンテスト|三千里-京畿コンテスト]]]** //(삼천리-경기)// - [[[samcheonri-contest-gyeonggi|第十四回「京畿道 」]]]。
 * **[[[/system:page-tags/tag/三千里-忠南コンテスト|三千里-忠南コンテスト]]]** //(삼천리-충남)// - [[[samcheonri-contest-chungnam|第十五回「忠清南道 」]]]。
...
* **[[[/system:page-tags/tag/2022夏季コンテスト|2022夏季コンテスト]]]** //(2022夏季征文)// - [[[summer-contest-2022|2022夏季"陥穽"コンテスト]]]。
...
* **[[[/system:page-tags/tag/2024怪談コンテスト|2024怪談コンテスト]]]** //(2024怪谈竞赛)// - [[[summer-contest-2023|2024怪談コンテスト]]]。
...
* **[[[/system:page-tags/tag/2025冬季コンテスト|2025冬季コンテスト]]]** //(2025冬季征文)// - [[[winter-contest-2025|2025冬季"諫言"コンテスト]]]。

* **[[[/system:page-tags/tag/2025goifコンテスト|2025goifコンテスト]]]** //(2025goif竞赛)// - [[[goif-contest-hub|2025"博戯"GoIFコンテスト]]]。

* **[[[/system:page-tags/tag/2025夏季コンテスト|2025夏季コンテスト]]]** //(2025夏季征文)// - [[[summer-contest-2025|2025夏季"復刻"コンテスト]]]。

* **[[[/system:page-tags/tag/2025新鋭コンテスト|2025新鋭コンテスト]]]** //(2025新秀竞赛)// - [[[newbee2025|2025“群雄逐鹿”新鋭コンテスト]]]。
...
* **[[[/system:page-tags/tag/syl2020|syl2020]]]** //(syl2020)// - [[[inicjatywy-sylwestrowe|2020年大晦日執筆チャレンジ]]]。
* **[[[/system:page-tags/tag/syl2022|syl2022]]]** //(syl2022)// - [[[inicjatywy-sylwestrowe|2022年大晦日執筆チャレンジ]]]。
--]
[[/tab]][!--PL--]
[[tab ES]]
...
* **[[[/system:page-tags/tag/cupidcon24-vn|cupidcon24-vn]]]** //(cupidcon24-vn)// - [[[cupidcon2024|キューピッドコンテスト2024]]]。
...
* **[[[/system:page-tags/tag/ポリシー|ポリシー]]]** //(policy)// - 実用的なサイト上のルールやポリシーを掲載するページに付与されるタグです。JPでは//他支部公式//タグに置換してください。
...
* **<wanderersカテゴリ用のタグ>** - {{wanderers:}}カテゴリに限定して使用されているタグ群です。詳しくは[[[https://scp-wiki-cn.wikidot.com/wanderers:tagging-guide|CN支部のタグリスト]]]を参照してください。
...
* **[[[/system:page-tags/tag/天と地|天と地]]]** //(himmel-und-erde)// - 「天と地」カノンに関連する作品に付与されます。カノン-DE「青玉色の空」の改訂版のタグですが、DE支部での改訂が進んでおらず長らく//青玉色の空//タグと共存している状態であるため、完了までの暫定的な措置として非使用のタグとします。
...
* **生物学**とは生命の諸要素、つまり細胞や臓器などを指します。しかしこの状態でも//生命//タグを使ってはいけません。
...
* //生命//は自動的に//生物学//でもあります。従って2つ併用する必要はなく、//生命//タグのみで十分です。
