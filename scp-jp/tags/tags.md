...
+++* "ジャンルとテーマ"タグについて
ENでは作品のジャンルや設定、フォーマット等を示すタグ群「[[span class="ruby"]]ジャンルとテーマ[[span class="rt"]]Genre and Themes[[/span]][[/span]]」が使用されています(例://adventure//、//political//、//foundation-format//)。//scp//、//goi-format//、//tale//と併用が可能であり、50種類以上のタグが実装されています。
